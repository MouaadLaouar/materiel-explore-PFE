    ...
    <>
      ...
      <div className="w-[90%] border-[1px] bg-white rounded-lg [box-shadow:0_0_5px_rgba(117,_117,_117,_0.3)] mx-auto">
        {dept.length !== 0 ? (
          <>
            ...
            <div className=" flex flex-col px-8 sm:px-0 sm:flex-row justify-around my-8">
              <p className="mt-1 truncate text-sm my-8 sm:my-0 font-mdMed leading-5 text-black">
                ...
                <a className=" z-10 text-[1.1rem] font-outfit">
                  {dept[0]?.Email}
                </a>
              </p>
          ...
          <>
          <p className="text-center mb-2 pt-10 text-2xl font-mdBold leading-9 tracking-tight text-gray-900">
            No Department Affected to you yet
          </p>
          <p className="text-center mt-2 pb-10 text-xl font-mdBold leading-9 tracking-tight text-teal-600">
            Contact The Super Admin For Help
          </p>
          </>
        )}
      </div>
